% OP_LAPLACEU_LAPLACEV_HIER: assemble the matrix A = [a(i,j)], a(i,j) = (epsilon laplace u_j, laplace v_i), 
%  for hierarchical C^1 B-splines
%
%   mat = op_laplaceu_laplacev_hier (spu, spv, msh, [epsilon], [patches]);
%   [rows, cols, values] = op_laplaceu_laplacev_hier (spu, spv, msh, [epsilon], [patches]);
%
% INPUT:
%
...
function varargout = op_laplaceu_laplacev_hier (hspu, hspv, hmsh, coeff, patch_list)
