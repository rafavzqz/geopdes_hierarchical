...
function varargout = op_u_v_mp_hier (hspu, hspv, hmsh, coeff, patch_list)
  ...
  for ilev = 1:hmsh.nlevels
    ...
    if (hmsh.nel_per_level(ilev) > 0)
      ...
      if (msh_lev.nel > 0)
        ...
        %M_lev = op_u_v_mp (hspu.space_of_level(ilev), hspv.space_of_level(ilev), hmsh.msh_lev{ilev}, coeff (x{:}));
        M_lev = op_u_v_mp (spu_lev, spv_lev, msh_lev, coeff (x{:}));
