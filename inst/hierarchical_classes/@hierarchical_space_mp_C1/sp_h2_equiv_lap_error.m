...
%
%   [errh2, errh1, errl2, errh2s, errh1s, errh2_elem, errh1_elem, errl2_elem, errh2s_elem, errh1s_elem] = sp_h2_equiv_lap_error (hspace, hmsh, u, uex, graduex, lapuex)
%
% INPUT:
%
...
% Copyright (C) 2017, 2018, 2023 Rafael Vazquez
%
...
errh2 = 0; errh1 = 0; errl2 = 0; errh2s = 0; errh1s = 0;
errh1_elem = zeros (1, hmsh.nel); errl2_elem = zeros (1, hmsh.nel); errh1s_elem = zeros (1, hmsh.nel);
errh2_elem = zeros (1, hmsh.nel); errh2s_elem = zeros (1, hmsh.nel);
