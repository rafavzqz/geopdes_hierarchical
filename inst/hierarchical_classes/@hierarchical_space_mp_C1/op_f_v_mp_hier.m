...
function rhs = op_f_v_mp_hier (hspace, hmsh, f, patch_list)
  ...
  for ilev = 1:hmsh.nlevels
    ...
    if (hmsh.nel_per_level(ilev) > 0)
      ...
      if (msh_lev.nel > 0)
        ...
        b_lev = op_f_v_mp (sp_lev, msh_lev, f(x{:}));
        %b_lev = op_f_v_mp (hspace.space_of_level(ilev), hmsh.msh_lev{ilev}, f(x{:}));
