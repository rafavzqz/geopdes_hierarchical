...
function varargout = op_u_v_hier_lowmem (hspu, hspv, hmsh, coeff)
  ...
  for ilev = 1:hmsh.nlevels
    ...
    if (hmsh.nel_per_level(ilev) > 0)
      ...
      for iel = 1:numel(active_elems)
        ...
        spu_lev = sp_evaluate_element_list (hspu.space_of_level(ilev), msh_aux, 'value', true);
        spv_lev = sp_evaluate_element_list (hspv.space_of_level(ilev), msh_aux, 'value', true);
        M_lev = op_u_v (spu_lev, spv_lev, msh_aux, coeff (x{:}));
