...
adaptivity_data.adm = 0; % 2 if admissible 1 if balancing
...
adaptivity_data.num_max_iter = 1+1;
...
% GRAPHICS
problem_output.folder = sprintf('Multitrack_Uniform_%d', 9);
...
plot_data.file_name = strcat(problem_output.folder, '/Multitrack_Uniform_%d');
plot_data.file_name_mesh = strcat(problem_output.folder, '/Multitrack_Uniform_mesh_%d.png');
plot_data.file_name_results= strcat(problem_output.folder, '/Multitrack_Uniform_results.csv');
plot_data.file_name_L2 = strcat(problem_output.folder, '/Multitrack_Uniform_solution.csv');
plot_data.file_name_H1 = strcat(problem_output.folder, '/Multitrack_Uniform_gradient.csv');
