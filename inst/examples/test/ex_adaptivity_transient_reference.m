...
for refLevel = 6:9
    ...
    method_data.nsub_coarse = [2^refLevel 2^refLevel];                 % Number of subdivisions of the coarsest mesh, with respect to the mesh in geometry
    ...
    adaptivity_data.mark_param = 0.0;
    ...
    % GRAPHICS
    problem_output.folder = sprintf('ArcUniform_P3_2to%d', refLevel);
