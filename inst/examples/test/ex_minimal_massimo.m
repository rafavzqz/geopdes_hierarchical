...
clear method_data
method_data.degree      = 5*ones(1,ndim);       % Degree of the splines
method_data.regularity  = 4*ones(1,ndim);       % Regularity of the splines
...
method_data.nquad       = 6*ones(1,ndim);       % Points for the Gaussian quadrature rule
