...
function  [geometry, hmsh, hspace, u, solution_data] = adaptivity_laplace_BPX (problem_data, method_data, adaptivity_data, plot_data)
...
% SOLVE AND PLOT
  ...
  [u, bpx] = adaptivity_solve_laplace_BPX (hmsh, hspace, problem_data, method_data);
