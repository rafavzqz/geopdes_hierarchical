function est = adaptivity_estimate_cahn_hilliard (u, hmsh, hspace, problem_data, adaptivity_data)
...
for ilev = 1:hmsh.nlevels
  if (hmsh.nel_per_level(ilev) > 0)
    ...
    [ int_elem] = ...
      integrals_elem_level (sp_level, msh_level, hspace.Csub{ilev}*u(1:last_dof(ilev)), type);
