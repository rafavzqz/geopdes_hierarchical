...
function [hmsh, hspace, u_coarse] = adaptivity_coarsen_fsb (hmsh, hspace, marked, adaptivity_data)
...
[hmsh_coarse, removed_cells] = hmsh_coarsen (hmsh, reactivated_elements);
hspace_coarse = hspace_coarsen (hspace, hmsh, reactivated_fun, removed_cells, reactivated_elements);
...
reactivated_balanced_fun = functions_to_reactivate_from_cells (hmsh, hspace, reactivated_balanced_elements);

[hmsh, removed_cells] = hmsh_coarsen (hmsh, reactivated_balanced_elements);
