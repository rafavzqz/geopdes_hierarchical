...
function [errh1, errl2, errh1s, errh1_elem, errl2_elem, errh1s_elem] = sp_h1_error_old (sp, msh, u, uex, graduex)

  grad_valu = sp_eval_grad_msh_old (u, sp, msh);
  ...
  [errl2, errl2_elem] = sp_l2_error_old (sp, msh, u, uex);
