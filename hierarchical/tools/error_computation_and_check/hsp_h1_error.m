% HSP_H1_ERROR: Evaluate the error in H^1 norm, for hierarchical splines.
%
...
function [errh1, errl2, errh1s, errh1_elem, errl2_elem, errh1s_elem] = hsp_h1_error (hspace, hmsh, u, uex, graduex)
